...
var TimeScatterPlot = (function() {
  function TimeScatterPlot(articlesData, id, callback) {
    // var margin = {
    //     top: 10,
    //     right: 20,
    //     bottom: 30,
  ...
  TimeScatterPlot.getTooltip = function() {
    if (!TimeScatterPlot.tooltip) {
      TimeScatterPlot.tooltip = d3
        .select("#viewPort")
        .append("div")
    ...
    return TimeScatterPlot.tooltip;
  };
  return TimeScatterPlot;
})();
var value = [
  {
...
new TimeScatterPlot(value, "#scatter");
